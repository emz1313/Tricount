...
--
-- Base de données : `prwb_2223_d02`
--
DROP DATABASE IF EXISTS `prwb_2223_d02`;
CREATE DATABASE IF NOT EXISTS `prwb_2223_d02` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `prwb_2223_d02`;
